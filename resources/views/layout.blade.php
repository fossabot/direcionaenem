    ...
    <nav class="navbar navbar-dark bg-primary navbar-full navbar-fixed-top">
        ...
        <ul class="nav navbar-nav pull-xs-right">
            <li class="nav-item dropdown">
                <a aria-haspopup="false" class="nav-link active dropdown-toggle p-a-0" data-toggle="dropdown" href="#" role="button">
                    <img alt="Avatar" class="img-thumbnail img-perfil" src="{{ asset('assets/img/perfil/estudante/1.jpg') }}" width="40">
                </img>
                {{ auth()->user()->nome }}
            </a>
...
<div class="sidebar sidebar-left sidebar-light sidebar-visible-md-up si-si-3 ls-top-navbar-xs-up sidebar-white-md" data-scrollable="" id="sidebarLeft">
