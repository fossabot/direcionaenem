...
<head>
    <meta charset="UTF-8">
    <title>Direciona Concursos</title>
    ...
    <!-- Direciona Styles -->
    <link href="/assets/css/styledireciona.css" rel="stylesheet">
...
<header id="header">
    <nav class="menulateral">
        <ul class="list-unstyled main-menu">
            ...
            <li class="text-right"><a href="#" id="nav-close">Esconder Menu <i class="fa fa-arrow-right"></i></a></li>
            <li><a href="#services">Concursos <span class="icon"></span></a></li>
            <li><a href="{{ url('/quemsomos') }}">Quem Somos <span class="icon"></span></a></li>
            <li><a href="#pricing">Planos <span class="icon"></span></a></li>
            <li><a href="#blog">Perguntas Frequentes <span class="icon"></span></a></li>
            <li><a href="#contact">Contato <span class="icon"></span></a></li>
        </ul>
    </nav>
    <nav class="main-navigation navbar-fixed-top" role="navigation" data-spy="affix" data-offset-top="200">
        <div class="container">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle navexpander nav-expander fixed">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right" id="main_navigation_menu">
                    <li class="link-inicio"><a href="{{ url('/login') }}"> Login</a></li>
                    <li class="link-trial"><a href="#header"><i class="fa fa-share"></i> Experimente 15 dias grátis!</a>
                    </li>
                    <li>
    ...
    <div class="overlay">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="main-text">
                        <h1 class="wow fadeInUp">Abra sua Conta!</h1>
                        <h2 class="wow fadeInUp" data-wow-delay=".7s">Frase de Impacto para destacar a opção de registro
                            na plataforma!</h2>
                        <div class="wow fadeInUp" data-wow-delay="1.5s"><a class="btn btn-border btn-lg"><i
                                        class="fa fa-refresh fa-spin"></i> COMECE AGORA</a></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="col-md-2"></div>
                    <div class="col-md-10">
                        <form action="{{ url('/') }}" class="cadastro_rapido" method="post">
                            {!! csrf_field() !!}
                ...
                <div class="col-md-12 text-center">
                    <div><a onclick="smoothScr.anim('services')" class="btn btn-chamada btn-lg"><i
                                    class="fa fa-angle-double-down fa-2x"></i></a></div>
                </div>
            </div>
        </div>
    </div>
...
<section id="services">
    <div class="container">
        <h1 class="section-title wow fadeIn" data-wow-delay=".2s"><span>Nossa</span> Plataforma de Estudos</h1>
        <div class="row">
            <div class="col-sm-6 col-md-3 wow fadeInUp">
                <div class="service-box">
                    <div class="content">
                        ...
                        <p>Lorem ipsum is simply dummy text of the printin and typesetting industry. Lorem ipsum has
                ...
                <div class="item">
                    ...
                    <div class="col-sm-6 col-md-6 wow fadeInRight" data-wow-offset="10">
                        <div class="side-right">
                            <p>
                                Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantlum doloremque
                                laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritais ea quasi
                                architecto beattae vista dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas
                                sit aspernatur aut odit aut fugit, sed quia consiquuntur magin dolores eos qui ratione
                                voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem iqsum quia dolor sit
                                amet, consectetur, adipisci velit, sed quia non numquam eisu modi tempora incidunt ut
                                labore et nostrum exercitationem ullam corporis suscipit laboriosam.
                            </p>
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="side-right">
                            <p>
                                ...
                                consiquuntur magin dolores eos qui ratione voluptatem sequi nesciunt. Neque porro
                                quisquam est, qui dolorem iqsum quia dolor sit amet, consectetur, adipisci velit, sed
                                quia non numquam eisu modi tempora incidunt ut labore et nostrum exercitationem ullam
                                corporis suscipit laboriosam.
                                Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantlum doloremque
                                laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritais ea quasi
                                architecto beattae vista dicta sunt explicabo. Nemo
                            </p>
                ...
                <div class="mix nwtwork" data-myorder="1">
                    <figure>
                        <div class="img">
                            ...
                            <div class="overlay">
                                <a data-lightbox="image1" href="/assets/img/portfolio/thumb/img1.jpg" class="link-left"><i
                ...
                <div class="mix design" data-myorder="2">
                    <figure>
                        <div class="img">
                            ...
                            <div class="overlay">
                                <a data-lightbox="image1" href="/assets/img/portfolio/thumb/img2.jpg" class="link-left"><i
                                            class="fa fa-plus"></i></a>
                                <a href="#" class="link-right"><i class="fa fa-link"></i></a>
                            </div>
                        </div>
                ...
                <div class="mix marketing awesome" data-myorder="3">
                    <figure>
                        <div class="img">
                            ...
                            <div class="overlay">
                                <a data-lightbox="image1" href="/assets/img/portfolio/thumb/img3.jpg" class="link-left"><i
                                            class="fa fa-plus"></i></a>
                                <a href="#" class="link-right"><i class="fa fa-link"></i></a>
                            </div>
                        </div>
                ...
                <div class="mix awesome" data-myorder="4">
                    <figure>
                        <div class="img">
                            ...
                            <div class="overlay">
                                <a data-lightbox="image1" href="/assets/img/portfolio/thumb/img4.jpg" class="link-left"><i
                                            class="fa fa-plus"></i></a>
                                <a href="#" class="link-right"><i class="fa fa-link"></i></a>
                            </div>
                        </div>
                ...
                <div class="mix design" data-myorder="5">
                    <figure>
                        <div class="img">
                            ...
                            <div class="overlay">
                                <a data-lightbox="image1" href="/assets/img/portfolio/thumb/img5.jpg" class="link-left"><i
                                            class="fa fa-plus"></i></a>
                                <a href="#" class="link-right"><i class="fa fa-link"></i></a>
                            </div>
                        </div>
                ...
                <div class="mix marketing" data-myorder="6">
                    <figure>
                        <div class="img">
                            ...
                            <div class="overlay">
                                <a data-lightbox="image1" href="/assets/img/portfolio/thumb/img6.jpg" class="link-left"><i
                                            class="fa fa-plus"></i></a>
                                <a href="#" class="link-right"><i class="fa fa-link"></i></a>
                            </div>
                        </div>
                ...
                <div class="mix awesome" data-myorder="1">
                    <figure>
                        <div class="img">
                            ...
                            <div class="overlay">
                                <a data-lightbox="image1" href="/assets/img/portfolio/thumb/img7.jpg" class="link-left"><i
                                            class="fa fa-plus"></i></a>
                                <a href="#" class="link-right"><i class="fa fa-link"></i></a>
                            </div>
                        </div>
                ...
                <div class="mix nwtwork design" data-myorder="1">
                    <figure>
                        <div class="img">
                            ...
                            <div class="overlay">
                                <a data-lightbox="image1" href="/assets/img/portfolio/thumb/img8.jpg" class="link-left"><i
                                            class="fa fa-plus"></i></a>
                                <a href="#" class="link-right"><i class="fa fa-link"></i></a>
                            </div>
                        </div>
                ...
                <div class="content-left">
                    <div class="box-left">
                        ...
                        <div class="content">
                            ...
                            <p>Lorem it has survived not only five centuries, but also the leap into electronic
        ...
        <div class="row">
            <div id="blog-slider" class="owl-carousel owl-theme">
                <div class="item wow fadeInLeft" data-wow-delay="0.4s">
                    <div class="blog-wrapper">
                        <div id="gallery" class="carousel slide" data-ride="carousel">
                            ...
                            <a class="left carousel-control" href="#gallery" data-slide="prev"><i
                                        class="fa fa-chevron-left"></i></a>
                            <a class="right carousel-control" href="#gallery" data-slide="next"><i
                ...
                <div class="item wow fadeInRight" data-wow-delay="0.4s">
                    <div class="blog-wrapper">
                        <div class="video">
                            <iframe src="//player.vimeo.com/video/117934677?color=ea6a47title=0byline=0portrait=0badge=0"
                                    width="365" height="268" frameborder="0" webkitallowfullscreen mozallowfullscreen
            ...
            <div class="col-sm-6 col-md-3 wow flipInY" data-wow-offset="10" data-wow-delay="0.2s">
                <div class="item-square">
                    ...
                    <div class="content">
                        ...
                        <div class="text">
                            <p>Sit amet. consectetur adipiscing elit. Aenean consectetur suscipit viverra Morbi non arcu
                                blandit</p>
                        </div>
                ...
                <div class="item wow fadeInDown" data-wow-delay="0.3s">
                    <div class="testimonial">
                        <div class="testimonial-text">
                            ...
                            <p>I Hired Anirudh Babbar to do my new website, the design was done very fast i was kept up
                                to date regularly and I have had the website re designed and its working perfectly, I
                                would recommend him to anyone.? TOP BLOKE!!! </p>
...
<section id="connected">
    <div class="container">
        <div class="row">
            ...
            <h3 class="discription wow fadeIn" data-wow-delay=".2s">Lorem Ipsum is simply dummy text of the printing and
...
<!-- DirecionaConcursos js -->
<script src="/assets/js/direcionaconcursos.js"></script>
