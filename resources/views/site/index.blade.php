			...
			<div class="row">
				<div class="col-md-6">
					<div class="main-text">
						...
						<h2 class="wow fadeInUp" data-wow-delay=".7s">Frase de Impacto para destacar a opção de registro na plataforma!</h2>
						<div class="wow fadeInUp" data-wow-delay="1.5s"><a class="btn btn-border btn-lg"><i class="fa fa-refresh fa-spin"></i> COMECE AGORA</a></div>
					</div>
				</div>
				<div class="col-md-6">
				...
				<div class="col-md-12 text-center">
					<div><a onclick="smoothScr.anim('services')" class="btn btn-chamada btn-lg"><i class="fa fa-angle-double-down fa-2x"></i></a></div>
				</div>
			</div>
		</div>
	</div>
